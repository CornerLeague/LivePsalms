...
**Live baseline:** `docs/lamplight/evals/2026-08-06-b2-passage-door` — 3/3 pass, $0.17, zero Scripture violations, zero display-ref leaks. Regression evidence that study chat was untouched **when B2 landed**: `docs/lamplight/evals/2026-08-06-b2-studychat-regression` (free, grounding-only). It was deliberately switched over afterwards — see the display-ref entry in the decisions below.
